"""GooglePay payment process request."""
...
class GooglePayProcessRequest(BaseRequest):
    """GooglePay process request."""
    ...
    def __init__(
        ...
        super().__init__("googlepay/process", merchant_id, private_key)
        self.pay_id = pay_id
